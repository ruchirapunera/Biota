...
class getOnlyGeneralPhysiciansAPI {

    getOnlyGeneralPhysiciansrequest(field) {

        const apiEndpoint = requestUtils.getEndpoint('getOnlyGeneralPhysiciansAPi');
                ...
                cy.fixture("json/authorization").then((authorizationData) => {
                    ...
                    const authPassword = authorizationData[0].password;
                        ...
                        cy.request({
                            ...
                            .as('getOnlyGeneralPhysiciansResponse').then((Response) => {
...
export default getOnlyGeneralPhysiciansAPI;